...
__C.DATASETS.FRANKASCAN.CATEGORY_FILE_PATH       = './datasets/FrankaScanv2.json'
# __C.DATASETS.FRANKASCAN.CATEGORY_FILE_PATH       = './datasets/FrankaScan-test.json'
__C.DATASETS.FRANKASCAN.POINTS_DIR_PATH          = './datasets/frankascanv2/%s/%s/'
__C.DATASETS.FRANKASCAN.PARTIAL_POINTS_PATH      = './datasets/frankascanv2/%s/%s/depth2pcd_%s.pcd'
#__C.DATASETS.FRANKASCAN.COMPLETE_POINTS_PATH     = './datasets/frankascanv2/%s/%s/depth2pcd_GT_%s.pcd'
