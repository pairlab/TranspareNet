...
def setup_experiment(cfg, config_file, postfix="", log_dir="./logs/", tensorboard_dir="./tensorboard/",
    ...
    if not debug:
        ...
        if training:
            if not os.path.exists(os.path.join(experiment.dir,os.path.basename(config_file))):
